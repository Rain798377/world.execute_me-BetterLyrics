...
transcript = [{'text': 'Switch on the power line', 'start': 0.1, 'duration': 1.64}, # 0
              ...
              {'text': 'Then I will give you my', 'start': 31.116, 'duration': 1.566},
              {'text': 'DIMENSION', 'start': 32.682, 'duration': 0.73, 'scramble': True, 'scramble_time': 0.5},
              {'text': "If I'm a circle", 'start': 33.412, 'duration': 1.234},
              {'text': 'Then I will give you my', 'start': 34.646, 'duration': 1.641},
              {'text': 'CIRCUMFERENCE', 'start': 36.287, 'duration': 0.78, 'scramble': True, 'scramble_time': 0.35},
              {'text': 'If I’m a sine wave', 'start': 37.067, 'duration': 1.529},
              {'text': 'Then you can sit on all my', 'start': 38.596, 'duration': 1.453},
              {'text': 'TANGENTS', 'start': 40.049, 'duration': 0.657, 'scramble': True, 'scramble_time': 0.3},
              {'text': 'If I approach infinity', 'start': 40.706, 'duration': 1.64},
              {'text': 'Then you can be my', 'start': 42.346, 'duration': 1.161},
              {'text': 'LIMITATIONS', 'start': 43.507, 'duration': 0.945, 'scramble': True, 'scramble_time': 0.4},
              ...
              {'text': 'And then', 'start': 47.672, 'duration': 0.3724},
              {'text': 'my vision', 'start': 48.4168, 'duration': 0.3724},
              ...
              {'text': 'unite', 'start': 56.55, 'duration': 0.339, 'append': True, 'scramble': True, 'scramble_time': 0.15},
              ...
              {'text': 'STIMULATIONS', 'start': 61.958, 'duration': 0.631, 'scramble': True, 'scramble_time': 0.4},
              ...
              {'text': 'SATISFACTION', 'start': 65.397, 'duration': 1.204, 'scramble': True, 'scramble_time': 0.8},
              {'text': 'If', 'start': 66.601, 'duration': 0.599}, # 1.651
              {'text': 'I can make you', 'start': 67.2, 'duration': 0.92, 'append': True},
              {'text': 'HAPPY', 'start': 68.12, 'duration': 0.132, 'scramble': True, 'scramble_time': 0.055},
              {'text': 'I will run the', 'start': 68.252, 'duration': 1.007},
              {'text': 'E X E C U T I O N', 'start': 69.259, 'duration': 0.825, 'scramble': True, 'scramble_time': 0.5},
              ...
              {'text': 'S I M U L A T I O N', 'start': 73.169, 'duration': 0.876, 'scramble': True, 'scramble_time': 0.5},
